...
export default function RegisterForm({ setBaseText, setGottenName, setSuccess }: Props) {
    ...
    return (
        <form 
            ...
            className="flex flex-col w-[84%] p-5">
            <label className="mb-2 text-xl" htmlFor="name">Nombre</label>
            <input 
                type="text" 
                required
                name="name" 
            ...
            />
            <label className="mb-2 text-xl" htmlFor="email">Email</label>
            <input 
                type="email" 
                required
                name="email" 
            ...
            />
            <label className="mb-2 text-xl" htmlFor="password">Contraseña</label>
            <input 
                type="password" 
                required
                name="password" 
            ...
            />
            <label className="mb-2 text-xl" htmlFor="confirmpassword">Confirmar contraseña</label>
            <input 
                type="password" 
                required
